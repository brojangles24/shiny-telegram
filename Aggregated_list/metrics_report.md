...
*Generated: 2025-11-29 08:29:14*

## 📜 Aggregation Summary
| Metric | Count | Insight |
| :--- | :---: | :--- |
| **Total Scored Domains** | **532,216** | Size of the list including TLD rejected entries. |
| Change vs. Last Run | `-25` ⬇️ | Trend in the total unique domain pool. |
| Priority List Size | 300,000 | Domains with **Min Score: 1 (Filtered-Full) | Cap: 300,000** (Max: 33). |
| High Consensus (Score 11+) | 133,623 | Domains backed by strong weighted evidence. |
| **Avg. Priority Score** | **9.74** | Average confidence score of the final list. |
| TLD Filter Exclusions | 67,213 | Domains rejected by the abusive TLD list. |
...
| `crys7a.crystalv1be.ru` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `owalafr.fr` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `nexusform-network-ai.com` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `geminl.com` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `nauda-velix.pro` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |

*The complete list of 232,216 excluded domains is in `excluded_domains_report.csv`.*
...
| **1HOSTS_LITE** | Aggregated/Wildcard | 6 | **Medium 🟨** | **Broad 🟩** | 92,589 | **85.22%** | <span style='color:green;'>`+0.2%`</span> | <span style='color:#2ca02c;'>███</span> |
| **OISD_BIG** | Aggregated/Wildcard | 5 | **High 🟥** | **Broad 🟩** | 216,360 | **64.80%** | <span style='color:green;'>`+0.0%`</span> | <span style='color:#1f77b4;'>███</span> |
| **ADGUARD_BASE** | ABP Rule List | 5 | **Medium 🟨** | **Medium 🟨** | 120,013 | **47.76%** | <span style='color:green;'>`+0.0%`</span> | <span style='color:#17becf;'>███</span> |
...
| :---: | :---: | :---: | :--- |
| 1 (e.g., d.d) | 180,962 | 60.32% | `google.com` |
| 2 (e.g., d.d.d) | 95,551 | 31.85% | `ads.google.com` |
| 3 (e.g., d.d.d.d) | 18,085 | 6.03% | `sub.ads.google.com` |
| 4 (e.g., d.d.d.d.d) | 4,012 | 1.34% | `sub.ads.google.com` |
| 5 (e.g., d.d.d.d.d.d) | 799 | 0.27% | `sub.ads.google.com` |
| 6 (e.g., d.d.d.d.d.d.d) | 283 | 0.09% | `sub.ads.google.com` |
