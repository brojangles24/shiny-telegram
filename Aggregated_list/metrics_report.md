...
| :--- | :---: | :--- |
| `vidroll.ru` | <span style='color:orange;'>**21**</span> | Score Cutoff: **21 is below minimum confidence 22.** |
| `metrics.csmonitor.com` | <span style='color:orange;'>**21**</span> | Score Cutoff: **21 is below minimum confidence 22.** |
| `xertive.com` | <span style='color:orange;'>**21**</span> | Score Cutoff: **21 is below minimum confidence 22.** |
| `stats.unionleader.com` | <span style='color:orange;'>**21**</span> | Score Cutoff: **21 is below minimum confidence 22.** |
| `filmyzadarmo.com.pl` | <span style='color:orange;'>**21**</span> | Score Cutoff: **21 is below minimum confidence 22.** |
...
| :--- | :---: | :--- |
| **Domains Added** | 28,166 | **28,166 Fresh** ✨ |
| **Domains Removed** | 0 | |
...
Analysis of the **28,166** domains *added* to the list this run.
| Property | Value | Insight |
| :--- | :---: | :--- |
| **Avg. *New* Domain Entropy** | `3.019` | 'Randomness' of *new* threats. A spike here is bad. |
