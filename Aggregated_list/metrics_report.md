...
*Generated: 2025-11-29 07:21:13*

## 📜 Aggregation Summary
| Metric | Count | Insight |
| :--- | :---: | :--- |
| **Total Scored Domains** | **532,241** | Size of the list including TLD rejected entries. |
| Change vs. Last Run | `+683` ⬆️ | Trend in the total unique domain pool. |
| Priority List Size | 300,000 | Domains with **Min Score: 1 (Filtered-Full) | Cap: 300,000** (Max: 33). |
| High Consensus (Score 11+) | 133,537 | Domains backed by strong weighted evidence. |
| **Avg. Priority Score** | **9.74** | Average confidence score of the final list. |
| TLD Filter Exclusions | 67,187 | Domains rejected by the abusive TLD list. |
...
| `gasinvestingsolutions.com` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `regulatory-legal.systems` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `ragaven09-21698.portmap.host` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `rechargepayorange.com` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |
| `comicsculpt.com` | <span style='color:orange;'>**5**</span> | Cap Cutoff: **300,000 list. list** |

*The complete list of 232,241 excluded domains is in `excluded_domains_report.csv`.*
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| **HAGEZI_ULTIMATE** | Aggregated/Wildcard | 7 | **High 🟥** | **Broad 🟩** | 235,074 | **79.75%** | <span style='color:green;'>`+0.4%`</span> | <span style='color:#d62728;'>███</span> |
| **1HOSTS_LITE** | Aggregated/Wildcard | 6 | **Medium 🟨** | **Broad 🟩** | 92,444 | **85.30%** | <span style='color:green;'>`+0.0%`</span> | <span style='color:#2ca02c;'>███</span> |
| **OISD_BIG** | Aggregated/Wildcard | 5 | **High 🟥** | **Broad 🟩** | 216,360 | **64.78%** | <span style='color:green;'>`+0.0%`</span> | <span style='color:#1f77b4;'>███</span> |
| **ADGUARD_BASE** | ABP Rule List | 5 | **Medium 🟨** | **Medium 🟨** | 119,995 | **47.76%** | <span style='color:green;'>`+0.0%`</span> | <span style='color:#17becf;'>███</span> |
...
| :---: | :---: | :---: | :--- |
| 1 (e.g., d.d) | 181,115 | 60.37% | `google.com` |
| 2 (e.g., d.d.d) | 95,428 | 31.81% | `ads.google.com` |
| 3 (e.g., d.d.d.d) | 18,060 | 6.02% | `sub.ads.google.com` |
| 4 (e.g., d.d.d.d.d) | 4,013 | 1.34% | `sub.ads.google.com` |
| 5 (e.g., d.d.d.d.d.d) | 796 | 0.27% | `sub.ads.google.com` |
| 6 (e.g., d.d.d.d.d.d.d) | 280 | 0.09% | `sub.ads.google.com` |
